...
/**
 * This class contains setters and getters for different attributes of GameMap
 * Object
 * 
 * @author d_modi
 */
public class GameMap {
	...
	/**
	 * method to get the Continent and Number of Territories needs to win the
	 * continent
	 * 
	...
	/**
	 * method to set the Continent and Number of Territories needs to win the
	 * continent
	 * 
	 ...
	 * 
	 * @return visitedContinentMapFlag : True, if continent is visited, otherwise
	 *         false
	 */
	 ...
	 * 
	 * @param visitedContinentMapFlag : True, if continent is visited, otherwise
	 *                                false
	 */
