...
/**
 * This interface is for the strategies that a player can have and contains the methods that change
 * with respect to the behaviour of the player and these methods will be implemented in the subsequent
...
public interface PlayerStrategy {
	...
	/**
	 * This the abstract method for which implementation will be provided in the classes which implement this interface.
	 * This method is for the fortification in which 
	 * @param player We pass the player object who is currently playing the game.
	 * @return enriched player object is returned
	 */
